  ...
  return (
    <div className="chat-container">
      ...
      <div className="button-container">
        <button onClick={handleGoBackDashboard} className="btn back-btn">
          Regresar al Dashboard
        </button>
        <button onClick={handleGoBackRides} className="btn back-btn">
          Regresar a Rides Activos
        </button>
      </div>
    </div>
  );
